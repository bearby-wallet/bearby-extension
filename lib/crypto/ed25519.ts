...
const padh = (num: number | bigint, pad: number) =>
  num.toString(16).padStart(pad, "0");
...
const etc = {
  ...
  concatBytes: concatB satisfies (...arrs: Bytes[]) => Uint8Array as (
    ...arrs: Bytes[]
  ) => Uint8Array,
  mod: M satisfies (a: bigint, b?: bigint) => bigint as (
    a: bigint,
    b?: bigint,
  ) => bigint,
