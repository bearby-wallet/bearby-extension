    ...
    (msg: any, sender: any, sendResponse: any) => {
      ...
      switch (msg.type) {
        ...
        case MTypePopup.ADD_ACCOUNT:
          wallet.createAccountFromSeed(
            msg.payload.name,
            msg.payload.appIndexies,
            sendResponse,
          );
          return true;
        ...
        case MTypePopup.APPROVE_CONNECTION:
          connections.approveConnections(
            msg.payload.index,
            msg.payload.accounts,
            sendResponse,
          );
        ...
        case MTypePopup.APPROVE_PUB_KEY_REQ:
          connections.requestPubKeyApproveReject(
